...
func TicketUrgeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TicketUrgeReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := ticket.NewTicketUrgeLogic(r.Context(), svcCtx)
		err := l.TicketUrge(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
