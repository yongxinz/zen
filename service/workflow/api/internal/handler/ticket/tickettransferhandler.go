...
func TicketTransferHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TicketTransferReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := ticket.NewTicketTransferLogic(r.Context(), svcCtx)
		err := l.TicketTransfer(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
