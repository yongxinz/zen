...
func ProcessClassifyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ProcessClassifyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := process.NewProcessClassifyLogic(r.Context(), svcCtx)
		resp, err := l.ProcessClassify(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
