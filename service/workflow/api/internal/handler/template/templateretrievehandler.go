...
func TemplateRetrieveHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TemplateRetrieveReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := template.NewTemplateRetrieveLogic(r.Context(), svcCtx)
		resp, err := l.TemplateRetrieve(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
